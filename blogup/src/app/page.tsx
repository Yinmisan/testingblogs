    ...
    <section className='flex items-center justify-center gap-20 p-5'>
      <FadeIn>
        <div className='md:space-y-10 space-y-8 relative z-10'>
          <header>
            <p className='text-muted-foreground text-lg font-extralight'>Hullo yall. I am</p>
            <AnimatedName />
            <h2 className='text-muted-foreground md:text-2xl sm:text-xl text-base'>
              <span className='animate-pulse'>&gt; </span>
              Worlds-end developer
            </h2>
          ...
          <div className='space-y-2 sm:text-sm text-xs'>
            ...
            <p className='text-muted-foreground'>
              ...
              <a target='_blank' href='https://github.com/wiscaksono/wiscaksono-site' className='text-light-brown  text-accent hover:underline hover:text-foreground transition-colors'>
                &apos;https://github.com/Yinmisan/TheUltimateYinmi&apos;
              </a>
            </p>
          </div>
        </div>
      ...
      <GridPattern
        className='absolute inset-x-0 -top-14 -z-10 h-full w-full dark:fill-neutral fill-neutral-100 dark:stroke-accent stroke-neutral-700/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]'
        yOffset={50}
        interactive
      />
    </section>
